<h2><a href="https://www.geeksforgeeks.org/problems/largest-prime-factor2601/1">Largest Prime Factor</a></h2><h3>Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p>Given a number <strong>n</strong>, your task is to find the largest prime factor of n.</p>
